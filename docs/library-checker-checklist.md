...
- [x] [Double-Ended Priority Queue](https://judge.yosupo.jp/problem/double_ended_priority_queue) (`double_ended_priority_queue`): 実装＋verifyあり — [Double Ended Priority Queue](../blueberry/data-structure/double-ended-priority-queue.hpp), [Ordered Multiset](../blueberry/data-structure/ordered-multiset.hpp), [verify](../verify/data-structure/double-ended-priority-queue.test.cpp), [verify](../verify/data-structure/ordered-multiset-priority-queue.test.cpp)
...
- [x] [Persistent Queue](https://judge.yosupo.jp/problem/persistent_queue) (`persistent_queue`): 実装＋verifyあり — [Persistent Array](../blueberry/data-structure/persistent-array.hpp), [Persistent Queue](../blueberry/data-structure/persistent-queue.hpp), [verify](../verify/data-structure/persistent-array.test.cpp), [verify](../verify/data-structure/persistent-queue.test.cpp)
...
- [x] [Persistent Unionfind](https://judge.yosupo.jp/problem/persistent_unionfind) (`persistent_unionfind`): 実装＋verifyあり — [Persistent Array](../blueberry/data-structure/persistent-array.hpp), [Persistent Union Find](../blueberry/data-structure/persistent-union-find.hpp), [Rollback Union Find](../blueberry/data-structure/rollback-union-find.hpp), [verify](../verify/data-structure/online-persistent-unionfind.test.cpp), [verify](../verify/data-structure/persistent-unionfind.test.cpp)
- [x] [Point Add Range Sum](https://judge.yosupo.jp/problem/point_add_range_sum) (`point_add_range_sum`): 実装＋verifyあり — [Dynamic Fenwick Tree](../blueberry/data-structure/dynamic-fenwick-tree.hpp), [Dynamic Sqrt Tree](../blueberry/data-structure/dynamic-sqrt-tree.hpp), [Fenwick Tree](../blueberry/data-structure/fenwick-tree.hpp), [verify](../verify/data-structure/dynamic-point-add-range-sum.test.cpp), [verify](../verify/data-structure/dynamic-sqrt-tree-sum.test.cpp), [verify](../verify/data-structure/point-add-range-sum.test.cpp)
- [x] [Point Add Rectangle Sum](https://judge.yosupo.jp/problem/point_add_rectangle_sum) (`point_add_rectangle_sum`): 実装＋verifyあり — [Dynamic Fenwick Tree 2D](../blueberry/data-structure/dynamic-fenwick-tree-2d.hpp), [Fenwick Tree](../blueberry/data-structure/fenwick-tree.hpp), [KD Tree](../blueberry/data-structure/kd-tree.hpp), [Offline Fenwick Tree 2D](../blueberry/data-structure/offline-fenwick-tree-2d.hpp), [Weighted Wavelet Matrix](../blueberry/data-structure/weighted-wavelet-matrix.hpp), [verify](../verify/data-structure/dynamic-point-add-rectangle-sum.test.cpp), [verify](../verify/data-structure/kd-tree.test.cpp), [verify](../verify/data-structure/point-add-rectangle-sum.test.cpp), [verify](../verify/data-structure/weighted-wavelet-matrix.test.cpp)
- [x] [Point Set Range Composite](https://judge.yosupo.jp/problem/point_set_range_composite) (`point_set_range_composite`): 実装＋verifyあり — [Dynamic Sqrt Tree](../blueberry/data-structure/dynamic-sqrt-tree.hpp), [Ordered Multiset](../blueberry/data-structure/ordered-multiset.hpp), [Persistent Segment Tree](../blueberry/data-structure/persistent-segment-tree.hpp), [Segment Tree](../blueberry/data-structure/segment-tree.hpp), [verify](../verify/data-structure/dynamic-sqrt-tree.test.cpp), [verify](../verify/data-structure/ordered-multiset-composite.test.cpp), [verify](../verify/data-structure/persistent-point-set-range-composite.test.cpp), [verify](../verify/data-structure/point-set-range-composite.test.cpp)
...
- [x] [Point Set Range Sort Range Composite](https://judge.yosupo.jp/problem/point_set_range_sort_range_composite) (`point_set_range_sort_range_composite`): 実装＋verifyあり — [Range Sort Range Product](../blueberry/data-structure/range-sort-range-product.hpp), [verify](../verify/data-structure/range-sort-range-product.test.cpp)
- [x] [Predecessor Problem](https://judge.yosupo.jp/problem/predecessor_problem) (`predecessor_problem`): 実装＋verifyあり — [Fast Set（64分木）](../blueberry/data-structure/fast-set.hpp), [Ordered Set](../blueberry/data-structure/ordered-set.hpp), [verify](../verify/data-structure/fast-set.test.cpp), [verify](../verify/data-structure/predecessor.test.cpp) — insert/erase/contains/lower_bound/floorを専用verifyで検証。
...
- [x] [Range Affine Point Get](https://judge.yosupo.jp/problem/range_affine_point_get) (`range_affine_point_get`): 実装＋verifyあり — [Dual Segment Tree](../blueberry/data-structure/dual-segment-tree.hpp), [verify](../verify/data-structure/dual-segment-tree.test.cpp), [ACL](https://atcoder.github.io/ac-library/production/document_en/lazysegtree.html) — ACL lazy_segtreeのapply(l,r,f)とget(p)で対応する。
...
- [x] [Range Parallel Unionfind](https://judge.yosupo.jp/problem/range_parallel_unionfind) (`range_parallel_unionfind`): 実装＋verifyあり — [Range Parallel Union Find](../blueberry/data-structure/range-parallel-union-find.hpp), [verify](../verify/data-structure/range-parallel-unionfind.test.cpp)
...
- [x] [Static Range LIS Query](https://judge.yosupo.jp/problem/static_range_lis_query) (`static_range_lis_query`): 実装＋verifyあり — [Static Range LIS](../blueberry/data-structure/static-range-lis.hpp), [Wavelet Matrix](../blueberry/data-structure/wavelet-matrix.hpp), [verify](../verify/data-structure/static-range-lis.test.cpp)
...
- [x] [Static Range Sum](https://judge.yosupo.jp/problem/static_range_sum) (`static_range_sum`): 実装＋verifyあり — [Disjoint Sparse Table](../blueberry/data-structure/disjoint-sparse-table.hpp), [Fenwick Tree](../blueberry/data-structure/fenwick-tree.hpp), [Sqrt Tree（静的）](../blueberry/data-structure/sqrt-tree.hpp), [verify](../verify/data-structure/disjoint-sparse-table.test.cpp), [verify](../verify/data-structure/sqrt-tree.test.cpp) — Disjoint Sparse Tableの非冪等な区間積を専用verifyで検証。静的な和だけなら通常の累積和でもO(N)構築・O(1)問い合わせにできる。
...
- [x] [Static RMQ](https://judge.yosupo.jp/problem/staticrmq) (`staticrmq`): 実装＋verifyあり — [Disjoint Sparse Table](../blueberry/data-structure/disjoint-sparse-table.hpp), [Linear RMQ](../blueberry/data-structure/linear-rmq.hpp), [Sparse Table](../blueberry/data-structure/sparse-table.hpp), [Sqrt Tree（静的）](../blueberry/data-structure/sqrt-tree.hpp), [verify](../verify/data-structure/disjoint-sparse-table-rmq.test.cpp), [verify](../verify/data-structure/linear-rmq.test.cpp), [verify](../verify/data-structure/sqrt-tree-rmq.test.cpp), [verify](../verify/data-structure/static-rmq.test.cpp)
...
- [x] [Shortest Path](https://judge.yosupo.jp/problem/shortest_path) (`shortest_path`): 実装＋verifyあり — [Skew Heap](../blueberry/data-structure/skew-heap.hpp), [Dijkstra](../blueberry/graph/dijkstra.hpp), [verify](../verify/data-structure/skew-heap.test.cpp), [verify](../verify/graph/shortest-path.test.cpp)
...
- [x] [Dynamic Tree Subtree Add Subtree Sum](https://judge.yosupo.jp/problem/dynamic_tree_subtree_add_subtree_sum) (`dynamic_tree_subtree_add_subtree_sum`): 実装＋verifyあり — [Euler Tour Tree](../blueberry/graph/euler-tour-tree.hpp), [verify](../verify/graph/euler-tour-tree.test.cpp)
- [x] [Dynamic Tree Vertex Add Path Sum](https://judge.yosupo.jp/problem/dynamic_tree_vertex_add_path_sum) (`dynamic_tree_vertex_add_path_sum`): 実装＋verifyあり — [Link-Cut Tree](../blueberry/graph/link-cut-tree.hpp), [verify](../verify/graph/link-cut-tree.test.cpp)
- [x] [Dynamic Tree Vertex Add Subtree Sum](https://judge.yosupo.jp/problem/dynamic_tree_vertex_add_subtree_sum) (`dynamic_tree_vertex_add_subtree_sum`): 実装＋verifyあり — [Dynamic Top Tree](../blueberry/graph/dynamic-top-tree.hpp), [Euler Tour Tree](../blueberry/graph/euler-tour-tree.hpp), [verify](../verify/graph/dynamic-top-tree-subtree.test.cpp), [verify](../verify/graph/euler-tour-tree-vertex-add.test.cpp)
- [x] [Dynamic Tree Vertex Set Path Composite](https://judge.yosupo.jp/problem/dynamic_tree_vertex_set_path_composite) (`dynamic_tree_vertex_set_path_composite`): 実装＋verifyあり — [Link-Cut Tree](../blueberry/graph/link-cut-tree.hpp), [verify](../verify/graph/link-cut-tree-composite.test.cpp)
- [x] [Frequency Table of Tree Distance](https://judge.yosupo.jp/problem/frequency_table_of_tree_distance) (`frequency_table_of_tree_distance`): 実装＋verifyあり — [Centroid Decomposition](../blueberry/graph/centroid-decomposition.hpp), [verify](../verify/graph/centroid-decomposition-thirds.test.cpp)
...
- [x] [Lowest Common Ancestor](https://judge.yosupo.jp/problem/lca) (`lca`): 実装＋verifyあり — [Linear RMQ](../blueberry/data-structure/linear-rmq.hpp), [Sparse Table](../blueberry/data-structure/sparse-table.hpp), [Linear LCA](../blueberry/graph/linear-lca.hpp), [Lowest Common Ancestor](../blueberry/graph/lowest-common-ancestor.hpp), [verify](../verify/graph/linear-lca.test.cpp), [verify](../verify/graph/lowest-common-ancestor-rmq.test.cpp), [verify](../verify/graph/lowest-common-ancestor.test.cpp)
- [x] [Point Set Tree Path Composite Sum](https://judge.yosupo.jp/problem/point_set_tree_path_composite_sum) (`point_set_tree_path_composite_sum`): 実装＋verifyあり — [Dynamic Top Tree](../blueberry/graph/dynamic-top-tree.hpp), [verify](../verify/graph/dynamic-top-tree.test.cpp)
- [x] [Point Set Tree Path Composite Sum (Fixed Root)](https://judge.yosupo.jp/problem/point_set_tree_path_composite_sum_fixed_root) (`point_set_tree_path_composite_sum_fixed_root`): 実装＋verifyあり — [Static Top Tree](../blueberry/graph/static-top-tree.hpp), [verify](../verify/graph/static-top-tree.test.cpp)
...
- [x] [Vertex Add Range Contour Sum on Tree](https://judge.yosupo.jp/problem/vertex_add_range_contour_sum_on_tree) (`vertex_add_range_contour_sum_on_tree`): 実装＋verifyあり — [Centroid Decomposition](../blueberry/graph/centroid-decomposition.hpp), [Contour Query](../blueberry/graph/contour-query.hpp), [verify](../verify/graph/contour-query.test.cpp)
...
- [x] [Vertex Get Range Contour Add on Tree](https://judge.yosupo.jp/problem/vertex_get_range_contour_add_on_tree) (`vertex_get_range_contour_add_on_tree`): 実装＋verifyあり — [Centroid Decomposition](../blueberry/graph/centroid-decomposition.hpp), [Contour Query](../blueberry/graph/contour-query.hpp), [verify](../verify/graph/contour-add.test.cpp)
...
- [x] [Min Plus Convolution (Convex and Convex)](https://judge.yosupo.jp/problem/min_plus_convolution_convex_convex) (`min_plus_convolution_convex_convex`): 実装＋verifyあり — [Splay Slope Trick](../blueberry/data-structure/splay-slope-trick.hpp), [verify](../verify/data-structure/splay-slope-trick.test.cpp)
...
- [x] [Longest Common Substring](https://judge.yosupo.jp/problem/longest_common_substring) (`longest_common_substring`): 実装＋verifyあり — [Longest Common Substring](../blueberry/string/longest-common-substring.hpp), [Suffix Automaton](../blueberry/string/suffix-automaton.hpp), [verify](../verify/string/longest-common-substring.test.cpp), [verify](../verify/string/suffix-automaton-lcs.test.cpp)
...
- [x] [Number of Substrings](https://judge.yosupo.jp/problem/number_of_substrings) (`number_of_substrings`): 実装＋verifyあり — [Suffix Automaton](../blueberry/string/suffix-automaton.hpp), [verify](../verify/string/suffix-automaton-substrings.test.cpp)
