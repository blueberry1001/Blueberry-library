...
- [x] [Static RMQ](https://judge.yosupo.jp/problem/staticrmq) (`staticrmq`): 実装＋verifyあり — [Disjoint Sparse Table](../blueberry/data-structure/disjoint-sparse-table.hpp), [Sparse Table](../blueberry/data-structure/sparse-table.hpp), [Sqrt Tree（静的）](../blueberry/data-structure/sqrt-tree.hpp), [verify](../verify/data-structure/disjoint-sparse-table-rmq.test.cpp), [verify](../verify/data-structure/sqrt-tree-rmq.test.cpp), [verify](../verify/data-structure/static-rmq.test.cpp)
